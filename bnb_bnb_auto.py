...
STATE_FILE = os.path.join(SCRIPT_DIR, 'bnb2_bn_state.json')
LOG_FILE = os.path.join(SCRIPT_DIR, 'bnb2_bn.log')
TRADE_LOG = os.path.join(SCRIPT_DIR, 'bnb2_bn_trades.txt')
...
class Analyzer:
    ...
    def plan(self):
        ...
        if d == 'SHORT':
            ...
            bnb2me = levels[0][1] if levels else 'market'
