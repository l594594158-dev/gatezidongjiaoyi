...
POSITION_SIZE = 10            # 合约张数 (1 SOL/张=10 SOL)
...
STATE_FILE = os.path.join(SCRIPT_DIR, 'sol_gate_state.json')
LOG_FILE = os.path.join(SCRIPT_DIR, 'sol_gate.log')
TRADE_LOG = os.path.join(SCRIPT_DIR, 'sol_gate_trades.txt')
