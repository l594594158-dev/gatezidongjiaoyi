...
### ③ BTC方向共振
山寨币做多时BTC必须在多头或至少横盘；做空时BTC必须在空头或横盘。
BTC剧烈反向运行(<2%波动免检，>2%警告，>5%否决山寨反向仓位)。
...
示例: CONFIRMED|BTC同向+OI增+入场差2%ATR可达+K线实体饱满
示例: REJECTED|入场差7%ATR不可达+费率0.012%偏多但未极端+持仓大户一致
"""
