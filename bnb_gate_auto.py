...
POSITION_SIZE = 1000            # 合约张数 (0.001 BNB/张=1 BNB)
...
STATE_FILE = os.path.join(SCRIPT_DIR, 'bnb_gate_state.json')
LOG_FILE = os.path.join(SCRIPT_DIR, 'bnb_gate.log')
TRADE_LOG = os.path.join(SCRIPT_DIR, 'bnb_gate_trades.txt')
